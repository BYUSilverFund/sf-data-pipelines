...
from pipelines.utils.tables import crsp_monthly_table
...
def crsp_monthly_backfill_flow(start_date: date, end_date: date) -> None:
    ...
    for year in tqdm(years, desc="CRSP Monthly"):
        ...
        crsp_monthly_table.create_if_not_exists(year)
        crsp_monthly_table.upsert(year, year_df)
